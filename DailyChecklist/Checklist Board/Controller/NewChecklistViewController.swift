...
class NewChecklistViewController: UIViewController {
    ...
    @IBAction func actionSave(_ saveButton: UIBarButtonItem) {
        ...
        guard CoreDataOperations.shared.createNewChecklist(checklist: Checklist(name: checklistNameField.text!, creationDate: Date(), resetTime: nil, items: checklistItems, lastResetAtTime: nil)) else {
